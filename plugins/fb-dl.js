  ...
  try {
    ...
    if (!query || !query.startsWith("http")) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, dumbass, gimme a proper *Facebook video URL*! Don’t waste *SPIRTY-XMD*’s time! 😤📹
...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    if (!data.success || !data.result) {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* couldn’t grab that video, fam! URL’s trash or somethin’s busted! 😣
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    if (!videoUrl) {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ No video worth downloadin’ here, fam! *SPIRITY-XMD* ain’t got time for this shit! 😆
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
...
◈━━━━━━━━━━━━━━━━◈`;
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* fucked up grabbin’ that video, fam! Try again, you got this! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
