  ...
  try {
    ...
    if (!isBot) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Get lost, poser! Only *SPIRITY-XMD* itself can flex this command! 😤🔒
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    if (!m.quoted?.message?.imageMessage) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, dumbass, reply to a damn *image* for *SPIRITY-XMD*’s glow-up! 🖼️😆
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    for (let i = 0; i < 3; i++) {
      try {
        ...
        if (i === 2) {
          ...
          return Matrix.sendMessage(m.from, {
            text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* can’t grab that image, fam! Shit’s broken, try again! 😣
◈━━━━━━━━━━━━━━━━◈`,
          }, { quoted: m });
        }
      }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD*’s new drip is fuckin’ 🔥! Profile pic set, boss! 😎💪
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  } catch (error) {
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* fucked up settin’ that pic, fam! Try again, you got this! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
