...
const menu = async (m, Matrix) => {
  try {
    ...
    if (validCommands.includes(cmd)) {
      const mainMenu = `
◈━━━━━━━━━━━━━━━━◈
│❒ ${toFancyFont("SPIRITY-XMD")} Command Menu ⚠
│
...
`;
      ...
      const fullResponse = `
◈━━━━━━━━━━━━━━━━◈
│❒ ${toFancyFont("SPIRITY-XMD")} - ${toFancyFont(menuTitle)} ⚠
│
│ 🤖 *${toFancyFont("Bot")}*: ${toFancyFont("SPIRITY-XMD")}
...
`;
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* hit a snag! Error: ${error.message || "Failed to load menu"} 😡
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
