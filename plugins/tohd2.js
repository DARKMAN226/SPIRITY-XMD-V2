  ...
  try {
    ...
    if (!m.quoted || m.quoted.mtype !== "imageMessage") {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, *SPIRITY-XMD* needs a quoted image to enhance, fam! 📸
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* crankin’ up that image quality... 🔍✨
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
    ...
    await Matrix.sendMessage(
      m.from,
      {
        ...
        caption: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* made your image HD AF, fam! 🖼️🔥
◈━━━━━━━━━━━━━━━━◈`,
      },
      { quoted: m }
    );
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* hit a snag enhancin’ that pic, fam! Try again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
