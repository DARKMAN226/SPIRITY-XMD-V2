  ...
  try {
    ...
    if (!quoted || (quoted.mtype !== "audioMessage" && quoted.mtype !== "videoMessage")) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, *SPIRITY-XMD* needs a quoted audio or video to ID, fam! 🎵
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    try {
      ...
      await Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* sniffin’ out that track, hold up... 🔍
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
...
◈━━━━━━━━━━━━━━━━◈`;
      ...
      await Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* couldn’t ID that track, fam! Try another! 😣
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
  } catch (error) {
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* hit a glitch, fam! Retry that jam! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
