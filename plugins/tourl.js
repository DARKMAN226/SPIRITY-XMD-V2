  ...
  try {
    ...
    if (!m.quoted || !["imageMessage", "videoMessage", "audioMessage"].includes(m.quoted.mtype)) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, *SPIRITY-XMD* needs a quoted image, video, or audio, fam! 📸🎥🎵
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
...
"*【▓▓▓▓▓▓▓▓▓▓】*",
    ...
    const { key } = await Matrix.sendMessage(
      m.from,
      { text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* uploadin’ your media... ${loadingMessages[currentMessageIndex]} 🚀
◈━━━━━━━━━━━━━━━━◈` },
      { quoted: m }
    );
...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    if (mediaType === "audio") {
      await Matrix.sendMessage(
        ...
        {
          text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* got your audio URL, fam! 🎵
│❒ 🔗 *URL*: ${mediaUrl}
◈━━━━━━━━━━━━━━━━◈`,
        },
        { quoted: m }
      ...
      await Matrix.sendMessage(
        m.from,
        {
          ...
          caption: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* got your ${mediaType} URL, fam! 📸🎥
│❒ 🔗 *URL*: ${mediaUrl}
◈━━━━━━━━━━━━━━━━◈`,
        },
        { quoted: m }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* hit a snag uploadin’, fam! Try again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
