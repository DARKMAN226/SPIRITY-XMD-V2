...
◈━━━━━━━━━━━━━━━━◈`,
      ...
      if (!botAdmin) {
        return Matrix.sendMessage(m.from, {
          text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* needs admin powers to run this, fam! 😏
◈━━━━━━━━━━━━━━━━◈`,
        }, { quoted: m });
      }
...
◈━━━━━━━━━━━━━━━━◈`,
      ...
      if (text === "on") {
        config.WELCOME = true;
        responseMessage = `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* welcome & left messages ON! Newbies beware! 🍷
◈━━━━━━━━━━━━━━━━◈`;
      } else if (text === "off") {
        config.WELCOME = false;
        responseMessage = `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* welcome & left messages OFF! Silent mode, fam! 👻
◈━━━━━━━━━━━━━━━━◈`;
      } else {
        responseMessage = `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, use it right, fam!
...
◈━━━━━━━━━━━━━━━━◈`;
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SPIRITY-XMD* hit a snag, fam! Try again, we still savage! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
